...
class SliderWidget extends StatefulWidget {
  ...
  void jumpToPage(int page) {
    final index = _getRealIndex(pageController.page!.toInt(), realPage!.toInt() - initialPage!.toInt(), itemCount!.toInt());
  ...
  Widget build(BuildContext context) {
    return getWrapper(PageView.builder(
      ...
      itemBuilder: (BuildContext context, int i) {
        final int index = _getRealIndex(i + widget.initialPage!.toInt(), widget.realPage!.toInt(), widget.itemCount!.toInt());
          ...
          builder: (BuildContext context, child) {
            ...
            double value = 0.5;
              if (widget.pageController.position.haveDimensions) {
                value = widget.pageController.page! - i;
              }
